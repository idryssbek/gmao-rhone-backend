...
def get_historique_complet():
    ...
    cur.execute("""
        ...
        WHERE i.date_saisie > NOW() - INTERVAL '30 days' ORDER BY i.date_saisie DESC
    """)
...
def setup_db():
    ...
    cur.execute("""
        ...
        ('Sébastien','0000','technicien','Sébastien'),('Henri','0000','technicien','Henri'),('Idryss','0000','technicien','Idryss'),
        ('Marine.B','0000','referent','Marine.B'),('Clarisse','0000','referent','Clarisse'),('Marie-Laure','0000','referent','Marie-Laure'),
        ('Karen','0000','referent','Karen'),('Marine.C','0000','referent','Marine.C'),('Mélanie','0000','referent','Mélanie'),
        ('Anne-Marie','0000','referent','Anne-Marie'),('Nicolas','0000','referent','Nicolas'),('Nassim','0000','referent','Nassim')
