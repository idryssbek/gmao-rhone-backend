...
def get_historique_complet():
    try:
        ...
        cur.execute("""
            ...
            WHERE i.date_saisie > NOW() - INTERVAL '30 days'
    ...
    try:
        ...
        cur.execute("""
            CREATE TABLE IF NOT EXISTS gmao_users (
                ...
                username TEXT UNIQUE, password_hash TEXT, role TEXT, nom_complet TEXT
            );
            CREATE TABLE IF NOT EXISTS interventions (
                id SERIAL PRIMARY KEY,
                date_saisie TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                ligne_production TEXT, machine_num TEXT, nom_operateur_intervenant TEXT,
                description TEXT, id_referent INTEGER, statut TEXT DEFAULT 'en_attente',
